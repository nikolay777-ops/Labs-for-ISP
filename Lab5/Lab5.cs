...
namespace LAB3
{
        ...
        public virtual void Menu(byte i)
        {
            switch (i)
            {
                ...
                case 7:
                    ...
                    break;
                default: Console.WriteLine("Input digit on the border of menu."); break;
            }
        }
    ...
    public class Youth : Human
    {
        protected byte educationalLevel;
        byte month;
        int countOfScholarship;
        ...
        public override void FindingBottles(int n)
        {
            base.FindingBottles(n);
            educationalLevel -= 3;
        }
    ...
    enum Businesess : byte
    {
        NightClub = 1,
        Farm
    }

    public sealed class BusinessYouth : Youth
    {
        ...
        public BusinessYouth(string name)
        : base(name)
        {  
        ...
        public override void Menu(byte i)
        {
            ...
            switch (i)
            {
                ...
                default: Console.WriteLine("You should input digit in the border of menu."); break;
            }
        }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            BusinessYouth pers = new BusinessYouth(Console.ReadLine());
            BusinessYouth.Info(main);
            ...
            while (true)
            {
                ...
                pers.IsAlive();
                pers.Info();
                byte i = pers.HeadMenu();
                pers.Menu(i);
                switch (i)
                {
                    case (byte)Actions.HP: pers.FillingHP(Human.CheckInput()); break;
                    case (byte)Actions.Happiness: pers.AddHappiness(Human.CheckInput()); break;
                    case (byte)Actions.Fullness: pers.FillingFulness(Human.CheckInput()); break;
                    ...
                    break;
                    case (byte)Actions.Education: pers.Studying(); break;
                    case (byte)Actions.NightClub: pers.NightClub(); break;
                }
            }
        }
    }
