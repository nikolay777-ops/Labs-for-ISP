    ...
    class Program
    {
        ...
        static void InputDataTwo(ref double rad, ref int firstDeg, ref int secondDeg)
        {
            ...
            while (!checkInputRad || !checkInputDeg1 || !checkInputDeg2)
            {
                ...
                checkInputRad = double.TryParse(Console.ReadLine(), out rad);
                checkInputDeg1 = Int32.TryParse(Console.ReadLine(), out firstDeg);
                checkInputDeg2 = Int32.TryParse(Console.ReadLine(), out secondDeg);
            }
            while ((firstDeg + secondDeg > 180) || (firstDeg == 0 || secondDeg == 0))
            {
                Console.WriteLine("You entered invalid size of triangle angles (it shoudn't be 0, 180), please try again.");
                checkInputDeg1 = Int32.TryParse(Console.ReadLine(), out firstDeg);
                checkInputDeg2 = Int32.TryParse(Console.ReadLine(), out secondDeg);
            }
        }
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("2 - radius and 2 angels of the circumscribed circle of Triangle.");
            int a;
            ...
            switch (a)
            {
                case 1:
                {
                    ...
                    {
                        Console.WriteLine("Triangle with such coordinates doesn't exist.");    
                    }
                    break;
                }
                case 2:
                {
                    ...
                    Console.WriteLine("The second side is " + side[1]);
                    Console.WriteLine("The third side is " + side[2]);
                    Console.WriteLine("Perimeter of triangle is " + (int)Perimeter(side));
                    Console.WriteLine("Square of triangle is " + Square(side));
